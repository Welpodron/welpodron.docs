  ...
  ({ navTree, tocMobileRef, shellContentRef }, forwardedRef) => {
    ...
    return (
      <>
        <aside
          ref={mergedRef}
          className={`fixed sidebar xl:sticky xl:self-start w-5 xl:w-[350px] h-full xl:h-screen bg-white text-sm top-0 z-[100] left-0 border-r border-slate-200 dark:bg-slate-900 dark:border-slate-800`}
        >
